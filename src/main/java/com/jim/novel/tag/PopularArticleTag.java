 ...
 */
@Service
public class PopularArticleTag extends TagPlugin{
    @Autowired
...
// 获取页面的参数
       // Integer folderId = Integer.parseInt(params.get("folderId").toString());
        ...
        try {
            ...
            env.setVariable("tag_hot_article", BEANS_WRAPPER.wrap(pageVo));
        } catch (FolderNotFoundException e) {
            env.setVariable("tag_hot_article", BEANS_WRAPPER.wrap(null));
        }
